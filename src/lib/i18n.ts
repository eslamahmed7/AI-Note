...
const ar: Record<string, string> = {
  ...
  'ai.sources': 'المصادر',
  'ai.no_key': 'مفتاح OpenAI مطلوب',
  'ai.configure_key': 'يرجى إضافة مفتاح OpenAI API في الإعدادات',
  ...
  'settings.openai_key': 'مفتاح OpenAI API',
...
const en: Record<string, string> = {
  ...
  'ai.sources': 'Sources',
  'ai.no_key': 'OpenAI Key Required',
  'ai.configure_key': 'Please add your OpenAI API key in Settings',
